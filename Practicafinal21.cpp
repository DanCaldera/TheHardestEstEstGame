...
public:
    ...
    void inicio (void)
    {
        ...
        while(p)
        {
            ...
            ventana.display(imagen_inicio_2);
            ventana.wait(100);
            if (ventana.is_keyENTER())
            {
                p=false;
            }
            ventana.display(imagen_inicio_3);
            ventana.wait(100);
            if (ventana.is_keyENTER())
            {
                p=false;
            }
            ventana.display(imagen_inicio_4);
            ventana.wait(100);
            if (ventana.is_keyENTER())
            {
                p=false;
            ...
            ventana.display(imagen_inicio_6);
            ventana.wait(100);
            if (ventana.is_keyENTER())
            {
                p=false;
            }
            ventana.display(imagen_inicio_7);
            ventana.wait(100);
            if (ventana.is_keyENTER())
            {
                p=false;
...
public:
    ...
    void punto_critico_enemigo_arriba_abajo_1 (void)
    {
        ...
        if (d<=20 or d2<=20 or d2<=20 or d2<=20)
        {
...
public:
    ...
    {
        x0 = 120, y0 = 160, x1 = 140, y1 = 180;
        q1 = 60, q2 = 60, q3 = 280, q4 = 60, q5 = 60, v1 = 280, v2 = 480, v3 = 380, v4 = 60, v5 = 60;
        salir = true;
        rebote=true;
        rebote2=true;
        ...
        while (salir)
        {
            ...
            imagen.draw_circle(v4,q4,17,rojo_2,1);
                ...
                if (v4 >= 55 and rebote == true or q4 >= 55 and rebote2 == true)
                {
                    v4++;
                    q4++;
                    if(q4 >= 280)
                ...
                if (v4 <= 285 and rebote == false or q4 <= 285 and rebote2 == false )
                {
                    v4--;
                    q4--;
                    if(q4 >= 280)
